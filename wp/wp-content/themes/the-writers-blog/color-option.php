<?php
	...
	$the_writers_blog_custom_css .='.site-footer ul li a:hover , .wp-block-button:hover a{';
	...
	$the_writers_blog_custom_css .='.wp-block-button a , .wc-block-grid__product-onsale  {';
		$the_writers_blog_custom_css .='background: '.esc_attr($the_writers_blog_theme_color).'!important;';
	$the_writers_blog_custom_css .='}';

	$the_writers_blog_custom_css .='.wp-block-button a , .wp-block-button a:hover , .wc-block-grid__product-onsale ,button.wc-block-components-checkout-place-order-button:hover, a.wc-block-components-totals-coupon-link:hover, a.components-button.wc-block-components-button.wp-element-button.wc-block-cart__submit-button.contained:hover, a.wc-block-components-checkout-return-to-cart-button:hover{';
		$the_writers_blog_custom_css .='border-color: '.esc_attr($the_writers_blog_theme_color).'!important;';
	$the_writers_blog_custom_css .='}';

	$the_writers_blog_custom_css .='button.wc-block-components-checkout-place-order-button:hover, a.wc-block-components-totals-coupon-link:hover, a.components-button.wc-block-components-button.wp-element-button.wc-block-cart__submit-button.contained:hover, a.wc-block-components-checkout-return-to-cart-button:hover{';
		$the_writers_blog_custom_css .='color: '.esc_attr($the_writers_blog_theme_color).'!important;';
	$the_writers_blog_custom_css .='}';
	...
	$the_writers_blog_btn_font_size_option = get_theme_mod('the_writers_blog_btn_font_size_option', 13);
	$the_writers_blog_custom_css .='.blogger .aboutbtn a,#slider .readbutton, .form-submit input[type="submit"]{';
	$the_writers_blog_custom_css .='font-size: '.esc_attr($the_writers_blog_btn_font_size_option).'px;';
	$the_writers_blog_custom_css .='}';
	...
	$the_writers_blog_theme_lay = get_theme_mod( 'the_writers_blog_button_text_transform','Uppercase');
	   if($the_writers_blog_theme_lay == 'Uppercase'){
		$the_writers_blog_custom_css .='.blogger .aboutbtn,#slider .readbutton, .form-submit input[type="submit"]{';
		$the_writers_blog_custom_css .='text-transform: uppercase;';
		$the_writers_blog_custom_css .='}';
	   }else if($the_writers_blog_theme_lay == 'Lowercase'){
		$the_writers_blog_custom_css .='.blogger .aboutbtn,#slider .readbutton, .form-submit input[type="submit"]{';
		$the_writers_blog_custom_css .='text-transform: lowercase;';
		$the_writers_blog_custom_css .='}';
	   }
	   else if($the_writers_blog_theme_lay == 'Capitalize'){
	    $the_writers_blog_custom_css .='.blogger .aboutbtn,#slider .readbutton, .form-submit input[type="submit"]{';
	    $the_writers_blog_custom_css .='text-transform: capitalize;';
		$the_writers_blog_custom_css .='}';
	   }

	// font weight
    $the_writers_blog_btn_font_weight = get_theme_mod('the_writers_blog_btn_font_weight');{
	$the_writers_blog_custom_css .='.blogger .aboutbtn a,#slider .readbutton, .form-submit input[type="submit"]{';
	$the_writers_blog_custom_css .='font-weight: '.esc_attr($the_writers_blog_btn_font_weight).';';
	$the_writers_blog_custom_css .='}';
	}   
    ...
    if($the_writers_blog_theme_lay == 'Default'){
		...
		$the_writers_blog_custom_css .='.box-content{';
			$the_writers_blog_custom_css .='margin:0;';
		$the_writers_blog_custom_css .='}';
	}else if($the_writers_blog_theme_lay == 'Content and Center'){
		$the_writers_blog_custom_css .='.blogger{';
			$the_writers_blog_custom_css .='';
		$the_writers_blog_custom_css .='}';
	}
	...
	$the_writers_blog_sliderbutton = get_theme_mod( 'the_writers_blog_enable_disable_slider',true);
	...
	if($the_writers_blog_footer_widget_image != false){
		$the_writers_blog_custom_css .='.site-footer{';
			...
			$the_writers_blog_custom_css .='background-repeat: no-repeat;';
		$the_writers_blog_custom_css .='background-size: cover;';
			$the_writers_blog_custom_css .='}';
	}

	$the_writers_blog_theme_lay = get_theme_mod( 'the_writers_blog_img_footer','scroll');
	if($the_writers_blog_theme_lay == 'fixed'){
		$the_writers_blog_custom_css .='.site-footer{';
			$the_writers_blog_custom_css .='background-attachment: fixed !important;';
		$the_writers_blog_custom_css .='}';
	}elseif ($the_writers_blog_theme_lay == 'scroll'){
		$the_writers_blog_custom_css .='.site-footer{';
			$the_writers_blog_custom_css .='background-attachment: scroll !important;';
		$the_writers_blog_custom_css .='}';
	}

	$the_writers_blog_footer_img_position = get_theme_mod('the_writers_blog_footer_img_position','center center');
	if($the_writers_blog_footer_img_position != false){
		$the_writers_blog_custom_css .='.site-footer{';
			$the_writers_blog_custom_css .='background-position: '.esc_attr($the_writers_blog_footer_img_position).'!important;';
		$the_writers_blog_custom_css .='}';
	} 

	$the_writers_blog_footer_heading_alignment = get_theme_mod( 'the_writers_blog_footer_heading_option','Center');
    if($the_writers_blog_footer_heading_alignment == 'Left'){
		$the_writers_blog_custom_css .='.site-footer h3{';
		$the_writers_blog_custom_css .='text-align: left;';
		$the_writers_blog_custom_css .='}';
	}else if($the_writers_blog_footer_heading_alignment == 'Center'){
		$the_writers_blog_custom_css .='.site-footer h3{';
			$the_writers_blog_custom_css .='text-align: center;';
		$the_writers_blog_custom_css .='}';
	}else if($the_writers_blog_footer_heading_alignment == 'Right'){
		$the_writers_blog_custom_css .='.site-footer h3{';
			$the_writers_blog_custom_css .='text-align: right;';
		$the_writers_blog_custom_css .='}';
	}

	$the_writers_blog_footer_content_alignment = get_theme_mod( 'the_writers_blog_footer_content_option','Center');
    if($the_writers_blog_footer_content_alignment == 'Left'){
		$the_writers_blog_custom_css .='.site-footer ul, .site-footer p, .site-footer .tagcloud{';
		$the_writers_blog_custom_css .='text-align: left;';
		$the_writers_blog_custom_css .='}';
	}else if($the_writers_blog_footer_content_alignment == 'Center'){
		$the_writers_blog_custom_css .='.site-footer ul, .site-footer p, .site-footer .tagcloud{';
			$the_writers_blog_custom_css .='text-align: center;';
		$the_writers_blog_custom_css .='}';
	}else if($the_writers_blog_footer_content_alignment == 'Right'){
		$the_writers_blog_custom_css .='.site-footer ul, .site-footer p, .site-footer .tagcloud{';
			$the_writers_blog_custom_css .='text-align: right;';
		$the_writers_blog_custom_css .='}';
	}
	...
	$the_writers_blog_footer_icon_font_size = get_theme_mod('the_writers_blog_footer_icon_font_size');
	$the_writers_blog_custom_css .='.site-info .socialicons a{';
	$the_writers_blog_custom_css .='font-size: '.esc_attr($the_writers_blog_footer_icon_font_size).'px;';
	$the_writers_blog_custom_css .='}';
	...
	if($the_writers_blog_theme_lay == 'Capitalize'){
	...
	// menu color
	$the_writers_blog_menu_color = get_theme_mod('the_writers_blog_menu_color');
	$the_writers_blog_custom_css .='.main-navigation a, .main-navigation ul li a, #site-navigation li a{';
			$the_writers_blog_custom_css .='color: '.esc_attr($the_writers_blog_menu_color).' !important;';
	$the_writers_blog_custom_css .='}';

	// Sub menu color
	$the_writers_blog_sub_menu_color = get_theme_mod('the_writers_blog_sub_menu_color');
	$the_writers_blog_custom_css .='.main-navigation ul.sub-menu a, .main-navigation ul.sub-menu li a, #site-navigation ul.sub-menu li a{';
			$the_writers_blog_custom_css .='color: '.esc_attr($the_writers_blog_sub_menu_color).' !important;';
	$the_writers_blog_custom_css .='}';
	$the_writers_blog_custom_css .='.main-navigation ul.sub-menu li{';
			$the_writers_blog_custom_css .='border-left-color: '.esc_attr($the_writers_blog_sub_menu_color).' !important;';
	$the_writers_blog_custom_css .='}';

	// menu hover color
	$the_writers_blog_menu_hover_color = get_theme_mod('the_writers_blog_menu_hover_color');
	$the_writers_blog_custom_css .='.main-navigation a:hover, .main-navigation ul li a:hover, .main-navigation .current_page_item > a:hover, .main-navigation .current-menu-item > a:hover, .main-navigation .current_page_ancestor > a:hover, #site-navigation li a:hover{';
			$the_writers_blog_custom_css .='color: '.esc_attr($the_writers_blog_menu_hover_color).' !important;';
	$the_writers_blog_custom_css .='}';

	// Sub menu hover color
	$the_writers_blog_sub_menu_hover_color = get_theme_mod('the_writers_blog_sub_menu_hover_color');
	$the_writers_blog_custom_css .='.main-navigation ul.sub-menu a:hover, .main-navigation ul.sub-menu li a:hover, .main-navigation .current_page_item > a:hover, .main-navigation .current-menu-item > a:hover, .main-navigation .current_page_ancestor > a:hover, #site-navigation ul.sub-menu li a:hover{';
			$the_writers_blog_custom_css .='color: '.esc_attr($the_writers_blog_sub_menu_hover_color).' !important;';
	$the_writers_blog_custom_css .='}';
	$the_writers_blog_custom_css .='.main-navigation ul.sub-menu li:hover{';
			$the_writers_blog_custom_css .='border-left-color: '.esc_attr($the_writers_blog_sub_menu_hover_color).' !important;';
	$the_writers_blog_custom_css .='}';

	// site title color option
	$the_writers_blog_site_title_color_setting = get_theme_mod('the_writers_blog_site_title_color_setting');
	$the_writers_blog_custom_css .=' site-title .logo h1 a,.site-title a{';
		$the_writers_blog_custom_css .='color: '.esc_attr($the_writers_blog_site_title_color_setting).'!important;';
	$the_writers_blog_custom_css .='} ';

	$the_writers_blog_tagline_color_setting = get_theme_mod('the_writers_blog_tagline_color_setting');
	$the_writers_blog_custom_css .=' .site-description{';
		$the_writers_blog_custom_css .='color: '.esc_attr($the_writers_blog_tagline_color_setting).'!important;';
	$the_writers_blog_custom_css .='} ';
    ...
    // -------------- site logo margin ------------
	$the_writers_blog_logo_margin = get_theme_mod('the_writers_blog_logo_margin', '');{ 
	$the_writers_blog_custom_css .='.logo{';
	$the_writers_blog_custom_css .='margin: '.esc_attr($the_writers_blog_logo_margin).'px ;';
	$the_writers_blog_custom_css .='}';
	}
	//  ------------------logo padding-----------
	$the_writers_blog_logo_padding = get_theme_mod('the_writers_blog_logo_padding');
	$the_writers_blog_custom_css .='.logo{';
	$the_writers_blog_custom_css .='padding: '.esc_attr($the_writers_blog_logo_padding).'px;';
	$the_writers_blog_custom_css .='}';
	...
	$the_writers_blog_padding_left_right_slider_content = get_theme_mod('the_writers_blog_padding_left_right_slider_content');
	$the_writers_blog_custom_css .='#slider .carousel-caption{';
		$the_writers_blog_custom_css .='top: '.esc_attr($the_writers_blog_padding_top_bottom_slider_content).'%; bottom: '.esc_attr($the_writers_blog_padding_top_bottom_slider_content).'%;left: '.esc_attr($the_writers_blog_padding_left_right_slider_content).'%;right: '.esc_attr($the_writers_blog_padding_left_right_slider_content).'%;';
	$the_writers_blog_custom_css .='}';

	// featured image setting
	$the_writers_blog_post_image_border_radius = get_theme_mod('the_writers_blog_post_image_border_radius', 0);
	$the_writers_blog_custom_css .='.blogger img, .wrapper img{';
		$the_writers_blog_custom_css .='border-radius: '.esc_attr($the_writers_blog_post_image_border_radius).'px;';
	$the_writers_blog_custom_css .='}';

	$the_writers_blog_featured_image_box_shadow = get_theme_mod('the_writers_blog_featured_image_box_shadow',0);
	$the_writers_blog_custom_css .='.blogger img, .wrapper img{';
		$the_writers_blog_custom_css .='box-shadow: '.esc_attr($the_writers_blog_featured_image_box_shadow).'px '.esc_attr($the_writers_blog_featured_image_box_shadow).'px '.esc_attr($the_writers_blog_featured_image_box_shadow).'px #ccc;';
	$the_writers_blog_custom_css .='}';

    //Copyright background css
	$the_writers_blog_copyright_background_color = get_theme_mod('the_writers_blog_copyright_background_color');
	$the_writers_blog_custom_css .='.copyright{';
		$the_writers_blog_custom_css .='background-color: '.esc_attr($the_writers_blog_copyright_background_color).';';
	$the_writers_blog_custom_css .='}';
     
	$the_writers_blog_copyright_text_color = get_theme_mod('the_writers_blog_copyright_text_color');
	$the_writers_blog_custom_css .='.site-info , .site-info a{';
		$the_writers_blog_custom_css .='color: '.esc_attr($the_writers_blog_copyright_text_color).'!important;';
	$the_writers_blog_custom_css .='}';

    // featured image dimention
	$the_writers_blog_post_image_dimention = get_theme_mod('the_writers_blog_post_image_dimention', 'Default');
	$the_writers_blog_post_featured_image_width = get_theme_mod('the_writers_blog_post_featured_image_width');
	$the_writers_blog_post_featured_image_height = get_theme_mod('the_writers_blog_post_featured_image_height');
	if($the_writers_blog_post_image_dimention == 'Custom Image Size'){
		$the_writers_blog_custom_css .='.blogger img{';
			$the_writers_blog_custom_css .='width: '.esc_attr($the_writers_blog_post_featured_image_width).'px; height: '.esc_attr($the_writers_blog_post_featured_image_height).'px;';
		$the_writers_blog_custom_css .='}';
	}

	// Single Post Categories
	$the_writers_blog_show_hide_single_post_categories = get_theme_mod('the_writers_blog_show_hide_single_post_categories',false);
	if ($the_writers_blog_show_hide_single_post_categories == false) {
		$the_writers_blog_custom_css .='.post-info{';
			$the_writers_blog_custom_css .=' margin-top:20px;';
		$the_writers_blog_custom_css .='}';
	}
 
    // Slider Width Layout
	$the_writers_blog_slider_width_options = get_theme_mod('the_writers_blog_slider_width_options', 'Full Width');
	if($the_writers_blog_slider_width_options == 'Full Width' ){
		$the_writers_blog_custom_css .='.page-template-home-custom #masthead .main-header{';
			$the_writers_blog_custom_css .=' position:absolute;';
		$the_writers_blog_custom_css .='}';
	}elseif($the_writers_blog_slider_width_options == 'Container Width' ){
		$the_writers_blog_custom_css .='.page-template-home-custom #masthead .main-header{';
			$the_writers_blog_custom_css .=' position:static;';
		$the_writers_blog_custom_css .='}';
		$the_writers_blog_custom_css .='.page-template-home-custom #masthead .main-header{';
			$the_writers_blog_custom_css .=' margin-top:0px;';
		$the_writers_blog_custom_css .='}';
		$the_writers_blog_custom_css .='#slider .carousel-caption{';
			$the_writers_blog_custom_css .=' top: 45%;';
		$the_writers_blog_custom_css .='}';
	} 

	// Blog post image border radious
    $the_writers_blog_blog_post_img_border_radius = get_theme_mod('the_writers_blog_blog_post_img_border_radius', 0);
	$the_writers_blog_custom_css .='.blogger img{';
		$the_writers_blog_custom_css .='border-radius: '.esc_attr($the_writers_blog_blog_post_img_border_radius).'px;';
	$the_writers_blog_custom_css .='}';

     // Blog post image box shadow
	$the_writers_blog_blog_post_img_box_shadow = get_theme_mod('the_writers_blog_blog_post_img_box_shadow',0);
	$the_writers_blog_custom_css .='.blogger img{';
		$the_writers_blog_custom_css .='box-shadow: '.esc_attr($the_writers_blog_blog_post_img_box_shadow).'px '.esc_attr($the_writers_blog_blog_post_img_box_shadow).'px '.esc_attr($the_writers_blog_blog_post_img_box_shadow).'px #ccc;';
	$the_writers_blog_custom_css .='}';
    
 	  // Single post image border radious
	$the_writers_blog_single_post_img_border_radius = get_theme_mod('the_writers_blog_single_post_img_border_radius', 0);
	$the_writers_blog_custom_css .='.blogger.singlebox img{';
		$the_writers_blog_custom_css .='border-radius: '.esc_attr($the_writers_blog_single_post_img_border_radius).'px !important;';
	$the_writers_blog_custom_css .='}';

	 // Single post image box shadow
	$the_writers_blog_single_post_img_box_shadow = get_theme_mod('the_writers_blog_single_post_img_box_shadow',0);
	$the_writers_blog_custom_css .='.blogger.singlebox img{';
		$the_writers_blog_custom_css .='box-shadow: '.esc_attr($the_writers_blog_single_post_img_box_shadow).'px '.esc_attr($the_writers_blog_single_post_img_box_shadow).'px '.esc_attr($the_writers_blog_single_post_img_box_shadow).'px #ccc !important;';
	$the_writers_blog_custom_css .='}';

	// Single post comments
	$the_writers_blog_post_comment_enable = get_theme_mod('the_writers_blog_post_comment_enable',true);
	if($the_writers_blog_post_comment_enable == false){
		$the_writers_blog_custom_css .='#comments{';
			$the_writers_blog_custom_css .='display: none;';
		$the_writers_blog_custom_css .='}';
	}

	//scroll to top css
	$the_writers_blog_scroll_background_color = get_theme_mod('the_writers_blog_scroll_background_color');
	$the_writers_blog_custom_css .='.scrollup i{';
	$the_writers_blog_custom_css .='background: '.esc_attr($the_writers_blog_scroll_background_color).';';
	$the_writers_blog_custom_css .='border-color: '.esc_attr($the_writers_blog_scroll_background_color).';';
	$the_writers_blog_custom_css .='}';

	$the_writers_blog_scroll_icon_color = get_theme_mod('the_writers_blog_scroll_icon_color');
	$the_writers_blog_custom_css .='.scrollup i{';
	$the_writers_blog_custom_css .='color: '.esc_attr($the_writers_blog_scroll_icon_color).';';
	$the_writers_blog_custom_css .='}';

	$the_writers_blog_scroll_background_hover_color = get_theme_mod('the_writers_blog_scroll_background_hover_color');
	$the_writers_blog_custom_css .='.scrollup i:hover{';
	$the_writers_blog_custom_css .='background: '.esc_attr($the_writers_blog_scroll_background_hover_color).';';
	$the_writers_blog_custom_css .='border-color: '.esc_attr($the_writers_blog_scroll_background_hover_color).';';
	$the_writers_blog_custom_css .='}';

	//Initial Cap
	$the_writers_blog_caps_enable = get_theme_mod('the_writers_blog_caps_enable', 'false');
	if($the_writers_blog_caps_enable == 'true' ){
	$the_writers_blog_custom_css .='.blogger .text p:nth-of-type(1)::first-letter{';
	$the_writers_blog_custom_css .=' font-size: 60px; font-weight: 800;';
	$the_writers_blog_custom_css .=' margin-right: 10px;';
	$the_writers_blog_custom_css .=' font-family: "Vollkorn", serif;';
	$the_writers_blog_custom_css .=' line-height: 1;';
	$the_writers_blog_custom_css .='}';
	}elseif($the_writers_blog_caps_enable == 'false' ){
	$the_writers_blog_custom_css .='.blogger .text p:nth-of-type(1)::first-letter {';
	$the_writers_blog_custom_css .='display: none;';
	$the_writers_blog_custom_css .='}';
	}

	// header position for slider on off

	if( get_theme_mod( 'the_writers_blog_slider_arrows',false) != true){
    	$the_writers_blog_custom_css .='.page-template-home-custom #masthead .main-header{';
			$the_writers_blog_custom_css .='position : static;';
		$the_writers_blog_custom_css .='} ';
	}
