			...
			<div id="footer-bottom">
				...
				<div class="pad group">
					...
					<div class="grid one-full">
						...
						<div id="credit">
							<p><?php esc_html_e('Powered by','blogcards'); ?> <a href="<?php esc_url( _e( 'https://wordpress.org', 'blogcards' ) ); ?>" rel="nofollow">WordPress</a>. <?php esc_html_e('Theme by','blogcards'); ?> <a href="http://alx.media" rel="nofollow">Alx</a>.</p>
						</div><!--/#credit-->
						<?php endif; ?>
