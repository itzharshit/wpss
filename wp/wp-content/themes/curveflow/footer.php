					...
					<div class="pad group">
						...
						<div class="grid one-full">
							...
							<div id="copyright">
								...
								<?php else: ?>
									<p><?php bloginfo(); ?> &copy; <?php echo esc_html( date_i18n( esc_html__( 'Y', 'curveflow' ) ) ); ?>. <?php esc_html_e( 'All Rights Reserved.', 'curveflow' ); ?></p>
								<?php endif; ?>
							</div><!--/#copyright-->
							
							<?php if ( get_theme_mod( 'credit', 'on' ) == 'on' ): ?>
							<div id="credit">
								<p><?php esc_html_e('Powered by','curveflow'); ?> <a href="<?php esc_url( _e( 'https://wordpress.org', 'curveflow' ) ); ?>" rel="nofollow">WordPress</a>. <?php esc_html_e('Theme by','curveflow'); ?> <a href="http://alx.media" rel="nofollow">Alx</a>.</p>
							</div><!--/#credit-->
							<?php endif; ?>
