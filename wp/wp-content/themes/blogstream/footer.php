		...
		<footer id="footer">
			...
			<?php if ( has_nav_menu('footer') ): ?>
				<div id="wrap-nav-footer" class="wrap-nav">
					<?php \Blogstream\Nav::nav_menu(array('theme_location'=>'footer','menu_id' => 'nav-footer','fallback_cb'=> false)); ?>
				</div>
			<?php endif; ?>
				...
				<div class="pad group">
					...
					<div class="grid one-full">
						...
						<div id="copyright">
							...
							<?php else: ?>
								<p><?php bloginfo(); ?> &copy; <?php echo esc_html( date_i18n( esc_html__( 'Y', 'blogstream' ) ) ); ?>. <?php esc_html_e( 'All Rights Reserved.', 'blogstream' ); ?></p>
							<?php endif; ?>
						</div><!--/#copyright-->
